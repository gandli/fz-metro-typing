...
// 主视区: 包住实际有地铁的 10 个区县真实经纬度范围 (排除福清/平潭/永泰后
// 实测 bbox: lon[118.515,119.899] lat[25.667,26.634])。
// 旧值 [119.0,25.8,119.85,26.25] 过窄, 导致闽清(西)、罗源/连江(北)、长乐(东南)
// 在 fitExtent 时被裁掉/压扁, 地图失真。现按真实范围设置, 并预留 2% padding。
